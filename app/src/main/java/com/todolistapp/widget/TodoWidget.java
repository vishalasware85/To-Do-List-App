...
import com.todolistapp.activities.MainActivity;
import com.todolistapp.activities.TodoAddActivity;
...
public class TodoWidget extends AppWidgetProvider {
    ...
    private void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        rv.setOnClickPendingIntent(R.id.todo_text_view_widget, PendingIntent.getActivity(context, 0, new Intent(context, MainActivity.class), PendingIntent.FLAG_IMMUTABLE));

        rv.setOnClickPendingIntent(R.id.todo_add_button_widget, PendingIntent.getActivity(context, 0, new Intent(context, TodoAddActivity.class), PendingIntent.FLAG_IMMUTABLE));
